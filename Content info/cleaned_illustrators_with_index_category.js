export default [
  ...
  },
  {
    ...
    "styleSummary": "This illustrator's style is characterized by its ability to convey deep emotion through seemingly simplified and often minimalist artwork.",
    "artworkKeywords": [
      "minimalist",
      "emotional",
      "simplified",
  ...
  },
  {
    ...
    "styleSummary": "Their characters typically appear stoic and still, yet convey significant emotion through subtle expressions, particularly in their eyes. The artwork frequently uses a muted, earthy color palette with strategic pops of color, contributing to a whimsical yet mysterious and sometimes dark atmosphere. A strong emphasis is placed on negative space and contrast, with sparse settings that communicate just enough to serve the narrative. There's a subtle, deadpan humor evident, and a tendency to imply action rather than explicitly show it, leaving room for interpretation. Symbolism, often through color, is a key element that adds layers of meaning to the simple compositions.",
    "artworkKeywords": [
      "minimalist",
      "ink wash",
      "watercolor textures",
  ...
  },
  {
    ...
    "styleSummary": "' illustration style is characterized by a charming, handmade quality, often blending various physical and digital media such as watercolor, acrylics, house paints, crayons, collage, pencil, and digital elements. The overall mood is whimsical, imaginative, and often dreamlike, with a focus ons simplicity and expression over intricate detail. There's a playful and understated humor, balancing profundity with lightheartedness, and a tactile, organic feel to the final pieces.",
    "artworkKeywords": [
      "watercolor",
      "acrylic",
      "crayon",
  ...
  },
  {
    ...
    "styleSummary": "Compositions are typically balanced with a central focus, depicting narrative scenes with fantastical creatures and enchanted forests. The illustrations feature detailed line work and textured surfaces, creating a child-friendly aesthetic with rounded shapes and soft edges, frequently evoking a European folklore or classic storybook charm.",
    "artworkKeywords": [
      "cartoonish",
      "expressive characters",
      "whimsical settings",
  ...
  },
  {
    ...
    "styleSummary": "This artist's distinctive and recognizable style is characterized by bold, angular, energetic, and whimsical drawings.",
    "artworkKeywords": [
      "loose lines",
      "expressive",
      "whimsical",
