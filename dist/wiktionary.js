 ...
 */
function detectDialect(audioUrl) {
    if (!audioUrl)
        return '';
    const lower = audioUrl.toLowerCase();
    if (lower.includes('-uk-') || lower.includes('en-gb') || lower.includes('en_gb'))
        return 'uk';
    if (lower.includes('-us-') || lower.includes('en-us') || lower.includes('en_us'))
        return 'us';
    return '';
}
