...
import { PROMPT_AGENT_1_STORY_CRAFTER_TEMPLATE, PROMPT_AGENT_2_ELABORATOR_TEMPLATE, PROMPT_AGENT_3_REVIEWER_TEMPLATE, PROMPT_AGENT_4_POLISHER_TEMPLATE, PROMPT_AGENT_5_CLEANER_TEMPLATE, PROMPT_AGENT_6_TITLER_TEMPLATE, PROMPT_AGENT_X_CONSOLIDATOR_TEMPLATE, } from './prompts/agent_prompts.js';
...
export async function runPipeline(pipelineConfig, pipelineData, commonInputs, storyOutputDiv) {
    ...
    for (const agentDef of pipelineConfig) {
        ...
        const agentOutput = await callAgentAPI(currentPrompt, commonInputs.apiKey, commonInputs.modelId, agentDef.name, 0, appState.lastRunChatLog, storyOutputDiv, commonInputs.minApiIntervalMs, enableThinking // Pass the flag to the API call
        );
