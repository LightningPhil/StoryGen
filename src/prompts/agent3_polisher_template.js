...
You have received:
1.  An initial text from a writer which includes a Story Circle outline, character descriptions, and a first story draft (collectively referred to as 'the draft material'). This draft material was intended to follow Dan Harmon's 8-step Story Circle.
2.  A list of expert review comments on the draft material, which includes specific feedback on its Story Circle execution.
